...
export default function Sie() {
  ...
  return (
    <SieLayout>
      <section className="grid grid-rows-2 gap-6 px-1 lg:px-12 py-4">
        <div className="flex flex-col items-center justify-center xl:flex-row space-y-6  xl:space-y-0 xl:space-x-6">
          <Image
            width={250}
            height={250}
        ...
        <div className="grid lg:grid-rows-3 grid-cols-1 lg:grid-cols-2 px-8 py-6 xl:px-12 xl:py-8  font-bold rounded-md h-[40%] xl:h-full bg-[#F0EFEB]">
          <p>
          ...
          <p>
            Créditos complementarios: <span></span>
          </p>
        </div>
      </section>
    </SieLayout>
